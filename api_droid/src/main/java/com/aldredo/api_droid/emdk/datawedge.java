package com.aldredo.api_droid.emdk;
...
public class datawedge {
	...
	public static final String DISABLE_UPCA_PREAMBLE 			= "DISABLE_UPCA_PREAMBLE";
	public static final String ENABLE_UPCA_PREAMBLE 			= "ENABLE_UPCA_PREAMBLE";
